...
import { Avatar, Box,Switch, Grid, IconButton, Button, Card, CardContent, CardHeader,Menu, MenuItem,ListItemIcon, ListItemText, Badge, Tooltip,CardActions, Divider, Typography, TextField } from '@mui/material';
        ...
        <CardContent sx={{padding:"10px 5px"}}>
            ...
            <Box display="flex" sx={{flexDirection:"column", gap:"7px"}}>
              <Box display="flex" sx={{gap:"7px", alignItems: "center", justifyContent: "center"}}>
                ...
                <Box display="flex" sx={{gap:"7px", alignItems: "center", justifyContent: "center"}}>
                {org.avatar != false && <Avatar src={"https://randomuser.me/api/portraits/men/"+randomIntFromInterval(1,100)+".jpg"} className={classes.avatar} sx={{ width: 30, height: 30 }} /> }          
