...
export default function ControlledTreeView({org}) {
  ...
  const icon = type =>{ faLandmark
    if(type==1) return <FontAwesomeIcon icon={faLandmark}  size="lg" />  
  ...
  return (
    <Box sx={{ height: 300, flexGrow: 1, width: 700, overflowY: 'auto' }}>
      <Box sx={{ mb: 1 }}>
