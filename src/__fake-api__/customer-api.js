  ...
  getCustomers() {
    const customers = [
      ...
      },
      {
        ...
        country: 'USA',
        currency: '$',
        email: 'siegbert.gottfried@procs.io',
        hasAcceptedMarketing: true,
        isProspect: false,
        isReturning: true,
